                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-100 rounded-xl shadow">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 border-b align-top">
                                    <div class="flex flex-col items-stretch gap-3">
                                        <a href="{{ route('edit.index', $ecospace->ecospaceID) }}" class="w-full flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg font-semibold shadow hover:bg-green-700 transition focus:outline-none">Edit</a>
                                        <form method="POST" action="{{ route('admin.ecospace.remove', $ecospace->ecospaceID) }}" data-confirm="Archive this EcoSpace? This will remove it from the public listing." class="w-full">
                                            @csrf
                                            <button type="submit" class="w-full inline-flex items-center justify-center gap-2 bg-red-100 text-red-700 px-4 py-2 rounded-lg font-semibold shadow hover:bg-red-200 transition focus:outline-none">Remove</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="10" class="px-6 py-4 border-b text-center text-gray-500">No approved ecospaces found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
