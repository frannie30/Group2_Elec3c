            ...
            <div class="bg-white rounded-xl shadow-lg p-8 w-full mx-auto">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <h1 id="page-title" class="text-3xl font-bold text-gray-900">Manage Events</h1>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-100 rounded-xl shadow">
                        ...
                        <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="11" class="px-6 py-4 border-b text-center text-gray-500">No approved events found.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
