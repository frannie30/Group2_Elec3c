            ...
            <div class="bg-white rounded-xl shadow-lg p-8 w-full mx-auto">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <h1 class="text-3xl font-bold text-gray-900">Event Archives</h1>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-100 rounded-xl shadow">
                        ...
                        <tbody>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 border-b align-top">
                                            <div class="flex flex-col gap-2">
                                                <form method="POST" action="{{ route('admin.events.restore', $event->eventID) }}">@csrf
                            ...
                            @else
                                <tr>
                                    <td colspan="11" class="px-6 py-4 border-b text-center text-gray-500">No archived events.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
