            ...
            <div class="bg-white rounded-xl shadow-lg p-8 w-full mx-auto">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <h1 class="text-3xl font-bold text-gray-900">EcoSpace Archives</h1>
                    </div>
                    <div class="hidden md:block text-sm text-gray-500">Use the sidebar to access Current / Add New / View Archives</div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-100 rounded-xl shadow">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 border-b align-top">
                                    <div class="flex flex-col gap-2">
                                        <form method="POST" action="{{ route('admin.ecospaces.restore', $ecospace->ecospaceID) }}">@csrf
                                            <button class="px-3 py-2 bg-green-600 text-white rounded">Restore</button>
                                        </form>
                                        <form method="POST" action="{{ route('admin.ecospaces.delete', $ecospace->ecospaceID) }}" data-confirm="Permanently delete this EcoSpace? This cannot be undone.">
                                            @csrf
                                            <button type="submit" class="admin-btn-negative px-3 py-2 rounded">Delete</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="13" class="px-6 py-4 border-b text-center text-gray-500">No archived ecospaces.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
