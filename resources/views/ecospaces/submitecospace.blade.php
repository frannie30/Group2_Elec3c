        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/90 backdrop-blur-lg shadow-2xl sm:rounded-2xl p-10 border border-emerald-200">
                ...
                <form method="POST" action="{{ route('ecospaces.store') }}" enctype="multipart/form-data"
                    ...
                    <!-- Ecospace Name -->
                    <div class="mb-6">
                        <label for="ecoName" class="block text-emerald-800 font-semibold mb-2">
                            <span class="text-emerald-700 font-bold">*</span> Ecospace Name
                        </label>
                        <input type="text" id="ecoName" name="ecoName" value="{{ old('ecoName') }}"
                    ...
                    <!-- Address -->
                    <div class="mb-6">
                        <label for="ecoAdd" class="block text-emerald-800 font-semibold mb-2">Address</label>
                        <input type="text" id="ecoAdd" name="ecoAdd" value="{{ old('ecoAdd') }}"
                               class="w-full border-2 border-emerald-200 rounded-xl px-4 py-3 bg-emerald-50 focus:ring-2 focus:ring-emerald-400"
                    ...
                    <!-- Description -->
                    <div class="mb-6">
                        <label for="ecoDesc" class="block text-emerald-800 font-semibold mb-2">Description</label>
                        <textarea id="ecoDesc" name="ecoDesc" rows="4"
                                  class="w-full border-2 border-emerald-200 rounded-xl px-4 py-3 bg-emerald-50 focus:ring-2 focus:ring-emerald-400"
                                  placeholder="Describe the ecospace (optional)">{{ old('ecoDesc') }}</textarea>
                        @error('ecoDesc')
                        <div class="text-red-500 mt-2 text-sm">{{ $message }}</div>
                        @enderror
                    </div>
